...
int main(int argc,const char * argv[])
{
  ...
  cl_mem told_mem_obj = clCreateBuffer(context, CL_MEM_READ_WRITE, length * width * sizeof(long double), NULL, &error);
  ...
  for(int i=0;i<num_iterations;++i)
  {
    ...
    clEnqueueReadBuffer(command_queue, told_mem_obj, CL_TRUE, 0, length * width * sizeof(long double), told , 0, NULL, NULL);
